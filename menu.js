class MenuScene extends Phaser.Scene {
    ...
    create() {
        ...
        var newstext = this.add.text(560, 250, ``, { fontSize: 'bold 30px', fill: '#FFFFFF' });
        ...
        missionbutton.on('pointerup', () => {
            if(gameState.dialogueover === true){
                ...
                if(gameState.missionnumber === 1){
                    ...
                    newstext = this.add.text(500, 300, `New missions\n coming soon!`, { fontSize: 'bold 30px', fill: '#FFFFFF' });
                    this.time.addEvent({
                        delay: 3000,
                        callback: ()=>{
                            newstext.destroy();
    ...
    update(){
        if(gameState.dialogueover === false && gameState.missionnumber === 2){
